...
import InputControl from "../InputControl/Input";
...
function Editor(props) {
  ...
  const projectBody = (
    <div className={styles.detail}>
      ...
      <InputControl
        label="Project Details & Overview"
      ...
      <div className={styles.row}>
        ...
        <InputControl
          label="Github Link"
          value={values.github}
          placeholder="Provide the github link of project"
          onChange={(event) =>
  ...
  const educationBody = (
    <div className={styles.detail}>
      ...
      <InputControl
        ...
        placeholder="Enter the name of your College/School"
        onChange={(event) =>
    ...
    <div className={styles.detail}>
      ...
      <div className={styles.row}>
        ...
        <InputControl
          label="Github Link"
          value={values.github}
          placeholder="Provide your Github profile link"
          onChange={(event) =>
            setValues((prev) => ({ ...prev, github: event.target.value }))
          }
        />
  ...
  const achievementsBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="List your Achievements & Publications "
          placeholder="Enter your achievement/publications"
          value={values.title}
  ...
  const skillsBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Title of your skill"
          value={values.title}
          placeholder="Enter the skill title eg. Technical Skills"
          onChange={(event) =>
            setValues((prev) => ({ ...prev, title: event.target.value }))
          }
        />
